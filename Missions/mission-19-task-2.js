/*
 * M19 T2
 * Created global counter fun_call_counter
 * Add counter by 1 every time apply is called

 * Assumption: primitive functions are not considered function calls
 * From Thaenesh's clarification on Telegram
*/
var fun_call_counter = 0;

function count_calls_made(program) {
    fun_call_counter = 0;
...
function apply_compound_function(fun, args) {
    fun_call_counter = fun_call_counter + 1;
